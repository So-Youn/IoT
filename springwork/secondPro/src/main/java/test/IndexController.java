 ...
 *    	---------- String : view에 대한 정보만 리턴할 때 사용
 *    			   ModelAndView : 공유할 데이터와 뷰에 대한 정보를 함께 리턴.	
 * 매개변수 : String , HttpServiceRequest, HttpServletResponse, HttpSession, Model , DTO....
 * */
@Controller  //컨트롤러 클래스
public class IndexController {
//상속하고 있는 클래스가 없기 때문에 메소드는 자유롭게 사용 가능하다.
	...
	public String main() {
		...
		return "test/index"; //view에 대한 정보 ; test 폴더 밑의 index
	}
